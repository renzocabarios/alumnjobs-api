...
const getAll = async (_req, _res) => {
  ...
  _res.send({ data, status: "success", message: "Get announcements success" });
};

const getById = async (_req, _res) => {
  const { id } = _req.params;
  const data = await service.getById(id);
  _res.send({ data: [data], status: "success", message: "Get announcements success" });
};
...
const add = async (_req, _res) => {
  ...
  _res.send({
    data: [data],
    status: "success",
    message: "Create announcements success",
  });
};
...
const update = async (_req, _res) => {
  ...
  _res.send({
    data: [data],
    status: "success",
    message: "Update announcements success",
  });
};
...
const deleteById = async (_req, _res) => {
  ...
  _res.send({
    data: [data],
    status: "success",
    message: "Delete announcements success",
  });
};
